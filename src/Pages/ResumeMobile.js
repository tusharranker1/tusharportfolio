...
export const Resume = () => {
  ...
  return (
    <div style={{ height: "180vh", width: "100%" }} className="resume-wrapper">
      <motion.div className="resume-content">
        ...
        <div className="education-card-first-content" data-aos='fade-down-left' data-aos-offset="100">
        ...
        <div className="education-card-second-content" data-aos='fade-down-right'>
          <h1>FuelCab-India</h1>
          <ul>
            <li>Full Stack Project</li>
            <li>Uses the React framework and contribute in making the dilevery tracking page</li>
